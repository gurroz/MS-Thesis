...
int SegmentedHashTest::runSegmentedHashSort(int** data, HashFunction& hashFunc, int arrayLength, SortFunction& sortFunction, int blockLength){
...
void SegmentedHashTest::runSortFunction(int** data, int arrayLength, SortFunction& sortFunction){
